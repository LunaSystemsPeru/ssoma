    ...
    var l = function (e, i) {
        ...
        h.prototype = {_constructor: function () {
                ...
                if (this.c.auto && -1 !== e.inArray(!0, e.map(a, function (a) {
                    ...
                    var g = d.columns().header().to$().clone(!1).wrapAll("tr").appendTo(b), c = e("<div/>").css({width: 1, height: 1, overflow: "hidden"}).append(c).insertBefore(d.table().node());
        ...
        h.defaults = {breakpoints: h.breakpoints, auto: !0, details: {renderer: function (d,
                        a) {
