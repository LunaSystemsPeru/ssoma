...
class ColaboradoresContrato
{
    ...
    {
        $query = "select cc.fecha_inicio, cc.fecha_fin, cc.id_contrato, pd.nombre 
                from colaboradores_contratos as cc
                inner join parametros_detalle as pd on cc.tipo_contrato = pd.id_detalle
                where cc.id_colaborador = '$this->idColaborador'";
