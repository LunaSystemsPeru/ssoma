...
class Colaborador
{
    ...
    {
        $sql = "insert into colaboradores values ('$this->idColaborador', '$this->documento', '$this->dato', '$this->domicilio', '$this->idUbigeo', '$this->fechaNacimiento', '$this->telefono', '$this->idCargo', '$this->foto', '$this->estado', '$this->ultimoIngreso', '$this->idEmpresa', '$this->nacionalidad', '$this->profesion', '$this->idGrupoSanguineo', '$this->idFactorSanguineo', '$this->idEstadoCivil', '$this->fichaPersonalScan')";
    ...
    public function actualizar()
    {
        $sql = "UPDATE colaboradores
                SET  ficha_personal_scan = '$this->fichaPersonalScan' WHERE  id_colaborador = '$this->idColaborador' " ;
         return $this->c_conectar->ejecutar_idu($sql);
    }
