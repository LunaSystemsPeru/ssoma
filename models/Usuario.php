...
class Usuario
{
    ...
    {
        $query = "select u.id_usuario, u.username, u.datos, u.celular, u.email, u.ultimo_login, u.estado, e.razon_social
        from usuarios as u 
            inner join empresas e on u.id_empresas = e.id_empresas
        order by datos asc";
