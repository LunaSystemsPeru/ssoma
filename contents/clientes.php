...
<head>
    ...
    <title>Clientes | Software Gestion de Seguridad Industrial</title>
            ...
            <div id="page-content">
                ...
                <div class="panel">
                    <div class="panel-heading">
                        <h3 class="panel-title"><b>Listar mis Clientes</b></h3>
                    </div>
                    <!--Data Table-->
                    <!--===================================================-->
...
<div class="modal" id="add_cliente" role="dialog" tabindex="-1" aria-labelledby="demo-default-modal" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <form action="../controller/reg_cliente.php" method="post" class="form-horizontal">
                <!--Modal header-->
