...
$mes_actual = date("m");
$anio_actual = date("Y");
$tipo = "ORDEN Y LIMPIEZA";
$id = $_GET['id'];
$anio = $_GET['anio'];
$empresa = $_SESSION['empresa'];

$inspecciones = "select id, anio, tipo, frecuencia, fecha_programa, fecha_inspeccion, pagina_web from programa_inspecciones where empresa = '" . $empresa . "' and id = '" . $id . "' and anio = '" . $anio . "' and tipo = '".$tipo."'";
...
<html lang="es">
    ...
    <head>
        ...
        <title>Inspecciones de Orden y Limpieza | Software Gestion de Seguridad Industrial</title>
        ...
        <script type="text/javascript">
            ...
            function ver_archivo(archivo) {
                direccion = "upload/" +<?php echo $empresa; ?> + "/inspecciones/ORDEN Y LIMPIEZA/" + archivo;
    ...
    <body>
                    ...
                    <div id="page-content">
                        ...
                        <div class="panel">
                            <div class="panel-heading">
                                <h3 class="panel-title"><a href="programa_inspecciones.php">Programa de Inspecciones</a> / <b>Programa de Inspecciones de Orden y Limpieza</b></h3>
                            </div>
                            <!--Data Table-->
                            <!--===================================================-->
                            <div class="panel-body">
                                <div class="pad-btm form-inline">
                                    ...
                                    <div>
                                        <a href="asistencia_capacitacion.php?id=&anio=">Ir a Pagina</a>
                                    </div>
                                </div>
                                <div class="table-responsive">
                                    <table class="table table-striped">
                                        ...
                                        <tbody>
                                            <?php
                                            $epp = "select ie.id, ie.anio, ie.item, ie.inspector, e.nombres, e.ape_pat, e.ape_mat, ie.fecha, ie.area, ie.local, ie.archivo, ie.estado from inspeccion_limpieza as ie inner "
                                                    . "join empleado as e on ie.empresa = e.empresa and ie.inspector = e.codigo where ie.id = '" . $id . "' and ie.anio = '" . $anio . "' and ie.empresa = '" . $empresa . "'";
                                            //echo $epp;
        ...
        <script type="text/javascript">
                                                ...
                                                function Reporte(id, anio, item) {
                                                    document.location.href = "reportes/inspeccion_limpieza.php?id=" + id + "&anio=" + anio + "&item=" + item;
                                                }
