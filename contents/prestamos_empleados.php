...
require '../models/PrestamoColaborador.php';
$prestamo = new PrestamoColaborador();
...
<head>
    ...
    <title>Prestamos | Software Gestion de Seguridad Industrial</title>
            ...
            <div id="page-content">
                ...
                <div class="panel">
                    <div class="panel-heading">
                        <h3 class="panel-title"><b>Listar Prestamos</b></h3>
                    </div>
                    <!--Data Table-->
                    <!--===================================================-->
                        ...
                        <div class="pad-btm form-inline">
                            <div class="row">
                                <div class="col-sm-6 table-toolbar-left">
                                    <button type="button" class="btn btn-primary btn-m"><i class="fa fa-plus"></i> Agregar</button>
                        ...
                        <div class="table-responsive">
                            <table class="table table-striped">
                                ...
                                <tr>
                                    ...
                                    <th class="text-center">Nro Cuotas</th>
                                ...
                                <tbody>
                                <?php
                                $a_prestamo = $prestamo->verFilas();
                                foreach ($a_prestamo as $fila) {
                                    ?>
                                    <tr>
                                        <td class="text-center"><?php echo $fila['datos'] ?></a></td>
                                        <td><?php echo $fila['fecha_prestamos']?></td>
                                        <td><?php echo $fila['nro_cuotas']?></td>
                                        <td class="text-center"><?php echo $fila['monto_total'] ?></td>
                                        ...
                                        <td class="text-center">
                                            <a href="prestamos_cuotas.php?id=<?php echo $fila['idprestamo'] ?>" class="btn btn-success btn-icon icon-lg fa fa-edit"></a>
