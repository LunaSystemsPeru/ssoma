<?php 
	...
	if (isset($_POST['graba_categoria'])){
		$nombre = strtoupper($_POST['nombres']);
		global $conn;
		$ins_epp = 'insert into categoria Values (null, "'.$nombre.'")';
...
<html lang="es">
	...
	<head>
		...
		<title>Categoria Colaborador | Software Gestion de Seguridad Industrial</title>
	...
	<body>
		<div id="container" class="effect mainnav-lg">
			...
			<div class="boxed">
							...
							<div class="panel-body">
								<div class="pad-btm form-inline">
									<div class="row">
										<div class="col-sm-6 table-toolbar-left">
											<button data-target="#add_categoria" data-toggle="modal" class="btn btn-primary btn-m">Agregar</button>
								...
								<div class="table-responsive">
									<table class="table table-striped">
										...
										<tbody>
											<?php 
												$busca_epp = "select * from categoria";
												...
												if ($resultado->num_rows > 0) {
													while ($fila = $resultado->fetch_assoc()) {
														...
														<button onclick="EditaCategoria(\''.$fila['id'].'\')" data-target="#edita_categoria" data-toggle="modal"class="btn btn-success btn-icon icon-lg fa fa-edit"></button>
				...
				<!--===================================================-->
				<div class="modal" id="add_categoria" role="dialog" tabindex="-1" aria-labelledby="demo-default-modal" aria-hidden="true">
				...
				<div class="modal" id="edita_categoria" role="dialog" tabindex="-1" aria-labelledby="demo-default-modal" aria-hidden="true">
					<div class="modal-dialog">
						<div name="contenido_edita_categoria" class="modal-content" id="contenido_edita_categoria">
		...
		<script type="text/javascript">
			function EditaCategoria(id_categoria) {
				var parametros = {
					"codigo" : id_categoria,
				};
				$.ajax({
					...
					type:  'post',
					beforeSend: function () {
                        $("#contenido_edita_categoria").html("Procesando, espere por favor...");
					},
					success:  function (response) {
                        $("#contenido_edita_categoria").html(response);
					}
				});
			}
		</script>
