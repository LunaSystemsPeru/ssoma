<?php 
	...
	if (isset($_POST['graba_epp'])){
		$nombre = strtoupper($_POST['nombre']);
		$duracion = strtoupper($_POST['duracion']);
		global $conn;
		$ins_epp = 'insert into epp Values (null, "'.$nombre.'", "'.$duracion.'", "1")';
...
<html lang="es">
	...
	<head>
		...
		<title>EPPs | Software Gestion de Seguridad Industrial</title>
					...
					<div id="page-content">
						...
						<div class="panel">
							<div class="panel-heading">
								<h3 class="panel-title"><b>Listar EPPs</b></h3>
							</div>
							<!--Data Table-->
							<!--===================================================-->
								...
								<div class="pad-btm form-inline">
									<div class="row">
										<div class="col-sm-6 table-toolbar-left">
											<button data-target="#add_epp" data-toggle="modal" class="btn btn-primary btn-m">Agregar</button>
