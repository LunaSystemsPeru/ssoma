							...
							<div class="col-lg-7">
								...
								<div id="demo-panel-network" class="panel">
									<div class="panel-heading">
										...
										<h3 class="panel-title">Eventos Planeados vs Ejecutados</h3>
									</div>
								...
								<div class="row">
									...
									<div class="col-sm-6 col-lg-6">
										...
										<div class="panel panel-info panel-colorful">
											<div class="pad-all">
												<p class="text-lg text-semibold">Capacitaciones</p>
												<p class="mar-no">
								...
								<div class="row">
									<div class="col-sm-6 col-lg-6">
										...
										<div class="panel panel-purple panel-colorful">
											<div class="pad-all">
												<p class="text-lg text-semibold">Inspecciones este mes</p>
												<p class="mar-no">
													<span class="pull-right text-bold">$764</span>
													Today
												</p>
									...
									<div class="col-sm-6 col-lg-6">
										...
										<div class="panel panel-warning panel-colorful">
											<div class="pad-all">
												<p class="text-lg text-semibold">Indicadores Base</p>
												<p class="mar-no">
