...
<html lang="es">
    ...
    <head>
        ...
        <title>Reportes Preliminares de Accidentes / Incidentes | Software Gestion de Seguridad Industrial</title>
        ...
        <script type="text/javascript">
            function add_preliminar() {
                document.location.href = "registrar_preliminar_incidente.php";
            }
            function reporte_preliminar(id, anio) {
                document.location.href = "reportes/preliminar_incidente.php?id=" + id + "&anio=" + anio;
            }
        </script>
    ...
    <body>
        <div id="container" class="effect mainnav-lg">
            ...
            <div class="boxed">
                    ...
                    <div id="page-content">
                        ...
                        <div class="panel">
                            <div class="panel-heading">
                                <h3 class="panel-title"><b>Listar Reportes Preliminares de Accidentes / Incidentes</b></h3>
                            </div>
                            <!--Data Table-->
                            <!--===================================================-->
                            <div class="panel-body">
                                <div class="pad-btm form-inline">
                                    <div class="row">
                                        <div class="col-sm-6 table-toolbar-left">
                                            <button onclick="add_preliminar()" class="btn btn-primary btn-m">Agregar</button>
                                ...
                                <div class="table-responsive">
                                    <table class="table table-striped">
                                        ...
                                        <tbody>
                                            <?php
                                            $preliminares = "select pi.*, e.nombres, e.ape_pat, e.ape_mat from preliminar_incidente as pi inner join empleado as e on pi.involucrado = e.codigo and pi.empresa = e.empresa where pi.empresa = '" . $empresa . "'";
                                            $resultado = $conn->query($preliminares);
                                            if ($resultado->num_rows > 0) {
                                                while ($fila = $resultado->fetch_assoc()) {
                                                    echo '<tr>
                                                    <td class="text-center">' . $fila['id'] . '</a></td>
                                                    <td class="text-center">' . $fila['anio'] . '</a></td>
                                                    <td class="text-center">' . $varios->fecha_tabla($fila['fecha']) . ' ' . $fila['hora'] . '</a></td>
                                                    <td>' . $fila['nombres'] . ' ' . $fila['ape_pat'] . ' ' . $fila['ape_mat'] . '</a></td>

                                                    <td class="text-center">' . $fila['consecuencia_probable'] . '</td>
                                                    ...
                                                    <button onclick="reporte_preliminar(\''.$fila['id'].'\', \''.$fila['anio'].'\')" class="btn btn-pink btn-icon icon-lg fa fa-print"></button>														
                ...
                <!--===================================================-->
                <div class="modal" id="add_cargo" role="dialog" tabindex="-1" aria-labelledby="demo-default-modal" aria-hidden="true">
                            ...
                            <form class="form-horizontal" id="frm_registra_cargo" action="" method="post">
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-7">
                                            <input type="number" min="1" class="form-control" name="jornal" placeholder="Jornal" required >
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="modal-footer">
                                    ...
                                    <input type="submit" class="btn btn-primary" name="graba_cargo">
                                </div>
                            </form>
                        </div>
                    </div>
                </div>
                <div class="modal" id="edita_cargo" role="dialog" tabindex="-1" aria-labelledby="demo-default-modal" aria-hidden="true">
                    <div class="modal-dialog">
                        <div name="contenido_edita_cargo" class="modal-content contenido_edita_cargo" id="contenido_edita_cargo">
        ...
        <script type="text/javascript">
                                                function EditaCargo(id_cargo) {
                                                    ...
                                                    $.ajax({
                                                        data: parametros,
                                                        url: 'frm_modificar/modificar_cargo.php',
                                                        type: 'post',
                                                        beforeSend: function () {
