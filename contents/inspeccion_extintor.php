...
<html lang="es">
    ...
    <head>
        ...
        <title>Inspeccion de Extintores| Software Gestion de Seguridad Industrial</title>
        ...
        <script type="text/javascript">
            ...
            function ver_archivo(archivo) {
                direccion = "upload/" +<?php echo $empresa; ?> + "/inspecciones/EXTINTORES/" + archivo;
    ...
    <body>
                    ...
                    <div id="page-content">
                        ...
                        <div class="panel">
                            <div class="panel-heading">
                                <h3 class="panel-title"><a href="programa_inspecciones.php">Programa de Inspecciones</a> / <b>Programa de Inspeccion de Extintores</b></h3>
                            </div>
                            <!--Data Table-->
                            <!--===================================================-->
                            <div class="panel-body">
                                ...
                                <div class="table-responsive">
                                    <table class="table table-striped">
                                        ...
                                        <tbody>
                                            <?php
                                            $epp = "select ie.id, ie.item, ie.anio, ie.inspector, e.nombres, e.ape_pat, e.ape_mat, ie.fecha, ie.area, ie.local, ie.archivo, ie.estado from inspeccion_extintores as ie inner join empleado as e on ie.empresa = e.empresa and ie.inspector = e.codigo where ie.id = '" . $id . "' and ie.anio = '" . $anio . "' and ie.empresa = '" . $empresa . "'";
                                            //echo $epp;
        ...
        <script type="text/javascript">
                                                ...
                                                function Reporte(id, anio, item) {
                                                    document.location.href = "reportes/inspeccion_extintores.php?id=" + id + "&anio=" + anio + "&item=" + item;
                                                }
