<?php 
	...
	if (isset($_POST['graba_evento'])){
		...
		global $conn;
		$ins_epp = 'insert into tipo_evento Values (null, "'.$nombre.'")';
		...
		{
			header('Location: tipo_evento.php');
		}
...
<html lang="es">
	...
	<head>
		...
		<title>Tipo de Eventos | Software Gestion de Seguridad Industrial</title>
	...
	<body>
		<div id="container" class="effect mainnav-lg">
			...
			<div class="boxed">
							...
							<div class="panel-body">
								<div class="pad-btm form-inline">
									<div class="row">
										<div class="col-sm-6 table-toolbar-left">
											<button data-target="#add_tipo_evento" data-toggle="modal" class="btn btn-primary btn-m">Agregar</button>
								...
								<div class="table-responsive">
									<table class="table table-striped">
										...
										<tbody>
											<?php 
												$busca_epp = "select * from tipo_evento";
												...
												if ($resultado->num_rows > 0) {
													while ($fila = $resultado->fetch_assoc()) {
														...
														<button onclick="EditaTipoEvento(\''.$fila['id'].'\')" data-target="#edita_categoria" data-toggle="modal"class="btn btn-success btn-icon icon-lg fa fa-edit"></button>
				...
				<!--===================================================-->
				<div class="modal" id="add_tipo_evento" role="dialog" tabindex="-1" aria-labelledby="demo-default-modal" aria-hidden="true">
					<div class="modal-dialog">
						<div class="modal-content">
							...
							<div class="modal-header">
								...
								<h4 class="modal-title">Registro de Tipo de Eventos</h4>
							</div>
							<form class="form-horizontal" id="frm_registra_categoria" action="" method="post">
								<!--Modal body-->
								...
								<div class="modal-footer">
									...
									<input type="submit" class="btn btn-primary" name="graba_categoria">
								</div>
							</form>
						</div>
					</div>
				</div>
				<div class="modal" id="edita_tipo_evento" role="dialog" tabindex="-1" aria-labelledby="demo-default-modal" aria-hidden="true">
					<div class="modal-dialog">
						<div name="contenido_edita_tipo_evento" class="modal-content" id="contenido_edita_tipo_evento">
		...
		<script type="text/javascript">
			function EditaTipoEvento(id) {
				var parametros = {
					"codigo" : id,
				};
				$.ajax({
					data:  parametros,
					url:   'modificar_tipo_evento.php',
					type:  'post',
					beforeSend: function () {
                        $("#contenido_edita_tipo_evento").html("Procesando, espere por favor...");
					},
					success:  function (response) {
                        $("#contenido_edita_tipo_evento").html(response);
					}
				});
			}
		</script>
