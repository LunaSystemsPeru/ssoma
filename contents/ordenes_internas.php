...
<head>
    ...
    <title>Orden Interna | Software Gestion de Seguridad Industrial</title>
            ...
            <div id="page-content">
                ...
                <div class="panel">
                    <div class="panel-heading">
                        <h3 class="panel-title"><b>Listar Ordenes de Servicio Internas</b></h3>
                    </div>
                    <!--Data Table-->
                    <!--===================================================-->
                    <div class="panel-body">
                        <div class="pad-btm form-inline">
                            <div class="row">
                                <div class="col-sm-6 table-toolbar-left">
                                    <a href="registra_orden_interna.php" id="demo-btn-addrow"
                        ...
                        <div>
                            <table id="demo-dt-basic" class="table table-striped table-condensed" cellspacing="0"
                                ...
                                <tbody>
                                <?php
                                $a_ordenes = $orden->verFilas();
                                foreach ($a_ordenes as $fila) {

                                    ?>
                                    <tr>
                                        <td class="text-center"><?php echo $fila['codigo']?></td>
                                        <td><?php echo $fila['raz_cliente'] ?></td>
                                        <td><?php echo $fila['raz_empresa']?></td>
                                        <td><?php echo $fila['servicio']?></td>
                                        <td class="text-right">S/ <?php echo number_format($fila['monto'], 2)?></td>
                                        <td class="text-center"><label class="label label-warning">Pendiente</label>
                                        </td>
                                        <td class="text-center">
                                            <a href="../reportes/orden_interna.php?id_orden=<?php echo $fila['idorden_interna']?>" target="_blank" class="btn btn-success btn-icon fa fa-clipboard"></a>
