                            ...
                            <div class="panel-body">
                                ...
                                <div class="table-responsive">
                                    <table class="table table-striped">
                                        ...
                                        <tbody>
                                            <?php
                                            $busca_epp = "select * from usuario where empresa = '" . $empresa . "'";
                                            $resultado = $conn->query($busca_epp);
                                            if ($resultado->num_rows > 0) {
                                                while ($fila = $resultado->fetch_assoc()) {
                                                    ?>
                                                    <tr>
                                                        <td class="text-center"><?php echo $fila['usuario'] ?></a></td>
                                                        <td><?php echo $fila['ape_pat'] . ' ' . $fila['ape_mat'] . ' ' . $fila['nombres'] ?></td>
                                                        <td><?php echo $fila['telefono'] ?></td>
                                                        <td><?php echo $fila['email'] ?></td>
                                                        <td  class="text-center">
                                                            <button onclick="EditaUsuario(<?php echo $fila['usuario'] ?>, <?php $fila['empresa'] ?>)" class="btn btn-success btn-icon icon-lg fa fa-edit"></button>
