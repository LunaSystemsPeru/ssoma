...
<html lang="es">
    ...
    <head>
        ...
        <title>Entrega de EPP -- Empleado | Software Gestion de Seguridad Industrial</title>
        ...
        <div id="container" class="effect mainnav-lg">
            ...
            <div class="boxed">
                ...
                <div id="content-container">
                    ...
                    <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
                    <div id="page-title">
                        <h1 class="page-header text-overflow">Entregar EPP</h1>
                    </div>
                    <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
                    <!--End page title-->
                    ...
                    <div id="page-content">
                        ...
                        <div class="row">
                            <form class="form-horizontal" enctype="multipart/form-data" id="graba_epp_empleado" action="../old_controller/entrega_epp.php" method="post">
                                <div class="col-lg-9">
                                    <div class="panel">
                                                ...
                                                <div class="panel-body">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-3">
                                                            ...
                                                            <!--===================================================-->
                                                            <select id="lista_epp" name="lista_epp" class="selectpicker">
                                                                <?php
                                                                global $conn;
                                                                $consulta = 'select * from epp order by nombre asc';
