<?php 
	...
	if (isset($_POST['graba_estado'])){
		$nombre = strtoupper($_POST['nombre']);
		global $conn;
		$ins_epp = 'insert into estado_civil Values (null, "'.$nombre.'")';
...
<html lang="es">
	...
	<head>
		...
		<title>Estado Civil | Software Gestion de Seguridad Industrial</title>
	...
	<body>
		<div id="container" class="effect mainnav-lg">
			...
			<div class="boxed">
					...
					<div id="page-content">
						...
						<div class="panel">
							<div class="panel-heading">
								<h3 class="panel-title"><b>Listar Estado Civil</b></h3>
							</div>
							<!--Data Table-->
							<!--===================================================-->
							<div class="panel-body">
								<div class="pad-btm form-inline">
									<div class="row">
										<div class="col-sm-6 table-toolbar-left">
											<button data-target="#add_estado" data-toggle="modal" class="btn btn-primary btn-m">Agregar</button>
								...
								<div class="table-responsive">
									<table class="table table-striped">
										...
										<tbody>
											<?php 
												$busca_epp = "select * from estado_civil";
												...
												if ($resultado->num_rows > 0) {
													while ($fila = $resultado->fetch_assoc()) {
														...
														<button onclick="EditaEstado(\''.$fila['id'].'\')" data-target="#edita_estado" data-toggle="modal"class="btn btn-success btn-icon icon-lg fa fa-edit"></button>
				...
				<!--===================================================-->
				<div class="modal" id="add_estado" role="dialog" tabindex="-1" aria-labelledby="demo-default-modal" aria-hidden="true">
					<div class="modal-dialog">
						<div class="modal-content">
							...
							<div class="modal-header">
								...
								<h4 class="modal-title">Registro de Estado Civil</h4>
							</div>
							<form class="form-horizontal" id="frm_registra_estado" action="" method="post">
								<!--Modal body-->
								...
								<div class="modal-footer">
									...
									<input type="submit" class="btn btn-primary" name="graba_estado">
								</div>
							</form>
						</div>
					</div>
				</div>
				<div class="modal" id="edita_estado" role="dialog" tabindex="-1" aria-labelledby="demo-default-modal" aria-hidden="true">
					<div class="modal-dialog">
						<div name="contenido_edita_estado" class="modal-content" id="contenido_edita_estado">
		...
		<script type="text/javascript">id_estado) {
				var parametros = {
					"codigo" : id_estado,
				};
				$.ajax({
					data:  parametros,
					url:   'modificar_estado.php',
					type:  'post',
					beforeSend: function () {
                        $("#contenido_edita_estado").html("Procesando, espere por favor...");
					},
					success:  function (response) {
                        $("#contenido_edita_estado").html(response);
					}
				});
			}
		</script>
