...
<html lang="es">
	...
	<head>
		...
		<title>Programa de Capacitaciones | Software Gestion de Seguridad Industrial</title>
	...
	<body>
		<div id="container" class="effect mainnav-lg">
			...
			<div class="boxed">
					...
					<div id="page-content">
						...
						<div class="panel">
							<div class="panel-heading">
								<h3 class="panel-title"><b>Listar Capacitaciones</b></h3>
							</div>
							<!--Data Table-->
							<!--===================================================-->
							<div class="panel-body">
								<div class="pad-btm form-inline">
									<div class="row">
										<div class="col-sm-6 table-toolbar-left">
											<button data-target="#add_capacitacion" data-toggle="modal" class="btn btn-primary btn-m">Agregar</button>
								...
								<div class="table-respo2323nsive">
									<table id="demo-dt-basic" class="table table-striped table-bordered" cellspacing="0" width="100%">
										...
										<tbody>
											<?php 
												$capacitaciones = "select id, anio, tema, fecha_programado, date_add(fecha_programado, interval duracion hour) as fecha_termino, fecha_ejecutado, fecha_fin, estado from programa_capacitaciones where empresa = '".$empresa."'";
												//echo $capacitaciones;
												...
												if ($resultado->num_rows > 0) {
													while ($fila = $resultado->fetch_assoc()) {
														...
														<td><a class="btn-link" href="" onclick="VerDetalle(\''.$fila['id'].'\', \''.$fila['anio'].'\')" data-target="#ver_detalle" data-toggle="modal">'.$fila['tema'].'</a></td>
														<td class="text-center">'.$fecha_inicio.'</td>
														<td class="text-center">'.$fecha_fin.'</td>
														<td class="text-center">'.$estado.'</td>
														<td>
														<button onclick="EditaCapacitacion(\''.$fila['id'].'\', \''.$fila['anio'].'\')" data-target="#edita_capacitacion" data-toggle="modal"class="btn btn-success btn-icon icon-lg fa fa-edit" '.$activo.'></button>
				...
				<!--===================================================-->
				<div class="modal" id="add_capacitacion" role="dialog" tabindex="-1" aria-labelledby="demo-default-modal" aria-hidden="true">
						...
						<div class="modal-content">
							...
							<div class="modal-header">
								...
								<h4 class="modal-title">Registro de Capacitaciones</h4>
                                                        ...
                                                        <form class="form-horizontal" id="frm_registra_capacitacion" action="../old_controller/add_capacitacion.php" method="post">
								<!--Modal body-->
								<div class="modal-body">
									<div class="form-group">
										<label class="col-lg-3 control-label">Tema</label>
										<div class="col-lg-7">
											<input type="text" placeholder="Tema" name="tema" class="form-control" required>
										</div>
									</div>
									<div class="form-group">
				...
				<div class="modal" id="edita_capacitacion" role="dialog" tabindex="-1" aria-labelledby="demo-default-modal" aria-hidden="true">
					<div class="modal-dialog">
