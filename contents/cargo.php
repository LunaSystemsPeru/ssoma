<?php 
	...
	if (isset($_POST['graba_cargo'])){
		$nombre = strtoupper($_POST['nombre']);
		$jornal = strtoupper($_POST['jornal']);
		global $conn;
		$ins_epp = 'insert into cargo Values (null, "'.$nombre.'", "'.$jornal.'")';
...
<html lang="es">
	...
	<head>
		...
		<title>Cargo | Software Gestion de Seguridad Industrial</title>
					...
					<div id="page-content">
						...
						<div class="panel">
							<div class="panel-heading">
								<h3 class="panel-title"><b>Listar Cargo</b></h3>
							</div>
							<!--Data Table-->
							<!--===================================================-->
								...
								<div class="pad-btm form-inline">
									<div class="row">
										<div class="col-sm-6 table-toolbar-left">
											<button data-target="#add_cargo" data-toggle="modal" class="btn btn-primary btn-m">Agregar</button>
											...
											<?php 
												...
												if ($resultado->num_rows > 0) {
													while ($fila = $resultado->fetch_assoc()) {
														...
														<td>'.$fila['nombre'].'</td>
														<td class="text-right">'.number_format($fila['jornal'], '2', '.', '').'</td>
