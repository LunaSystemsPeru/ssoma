<?php
	...
	$ver_datos = "select he.id, he.empresa, e.razon_social, he.fecha_entrega, t.dni, t.nombres, car.nombre as cargo "
                ...
                . "where he.id = '".$entrega."' and he.empresa = '".$empresa."' and he.empleado = '".$empleado."'";
	...
	$pdf->SetFont('Arial','',9);
		...
		$ver_epps = "select dhe.epp as codigo_epp, e.nombre as epp, e.duracion, he.fecha_entrega, adddate(he.fecha_entrega, interval e.duracion day) as fecha_devolucion from detalle_historial_epp as dhe inner join epp as e on dhe.epp = e.id inner join historial_epp as he on dhe.id = he.id and dhe.empresa = he.empresa and dhe.empleado = he.empleado where he.id = '".$entrega."' and he.empresa = '".$empresa."' and he.empleado = '".$empleado."'";
	...
	$pdf->SetFont('Arial','',8);
	$pdf->RotatedText(10,140,"SST-REG-150     Vr. 01      Fec. Aprob.: 03/10/2016",90);
	$pdf->SetFont('Arial','',9);
	$pdf->SetY(-25);
