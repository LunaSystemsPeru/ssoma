...
<head>
    ...
    <title>Notificacion de Cobro de Facturas</title>
    <style>
        /* -------------------------------------
            GLOBAL RESETS
        ------------------------------------- */
...
<body class="">
<span class="preheader">Resumen de cobros de la semana</span>
                    ...
                    <tr>
                        <td class="wrapper">
                            <table role="presentation" border="0" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td>
                                        <h2><b>RESUMEN DE CUENTAS POR COBRAR</b></h2>
                                        <p>a continuacion se envia el resumen de cuentas por cobrar por cliente, especificando las empresas emisoras</p>
                                        <hr>
                                        <table >
                                            <thead>
                                            <tr>
