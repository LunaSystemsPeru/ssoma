...
$(document).ready(function() {
	...
	// =================================================================
	$('#frm_registra_epp').bootstrapValidator({
		excluded: [':disabled'],
		...
		duracion: {
			validators: {
				notEmpty: {
					message: 'Colocar Nro de Dias de Duracion'
				},
				digits: {
					message: 'Solo Numero'
				}
	...
	// FORM VALIDATION ON TABS
	// =================================================================
	$('#frm_add_documento').bootstrapValidator({
		excluded: [':disabled'],
		feedbackIcons: faIcon,
		fields: {
		fullName: {
	...
	$('#fecha_evento').mask('99/99/9999 99:99');
	$('#fecha_entrega').mask('99/99/9999');
	$('#fecha_devolucion').mask('99/99/9999');
	$('#fecha_creacion').mask('99/99/9999');
	$('#fecha_ingreso').mask('99/99/9999');
	$('#fecha_registro').mask('99/99/9999');
	$('#fecha_afiliacion').mask('99/99/9999');
	$('#fecha_ejecucion').mask('99/99/9999');
	$('#hora_registro').mask('99:99:99');
	$('#hora_inicio').mask('99:99:99');
	$('#hora_fin').mask('99:99:99');
	$('#nro_dni').mask('99999999');
	$('#brevete').mask('a99999999');
	$('#anio').mask('9999');
